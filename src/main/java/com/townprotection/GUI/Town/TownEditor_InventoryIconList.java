...
public class TownEditor_InventoryIconList extends ListGUIAbstract<GuiManager.ListGUIPreset> {
    ...
    public Enum<GuiManager.ListGUIPreset> getType() {
        return GuiManager.ListGUIPreset.TOWN_ICON_PLAYER_INVENTORY_LIST;
    }
}
